   ...
   <>
     ...
     <section className='mt-10'>
        <Container className='px-4 '>
            <h1 className='font-onest  font-bold text-xl sm:text-2xl text-Rich-Black  '>Which of these best describes the incident?</h1>

            <div className='flex flex-wrap md:justify-normal justify-center  gap-[11px] pt-[25px]'>
                {
